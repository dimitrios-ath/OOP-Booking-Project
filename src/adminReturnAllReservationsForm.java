...
public class adminReturnAllReservationsForm extends JPanel {
    JFrame jframe;
    adminReturnAllReservationsForm currentForm;
    ...
    public void setCurrentForm(adminReturnAllReservationsForm currentForm) {
